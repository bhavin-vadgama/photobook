$(document).ready(function(){
    ...
    /*if(e>767){
        $(".img-group-gallery").colorbox(
            {rel:"gallery-images",width:"auto",height:"90%",current:"{current}/{total}"});
        $(".img-slideshow").colorbox({rel:"gallery-slideshow",width:"auto",height:"90%",slideshow:true,current:"{current}/{total}"})}
    else{
        $(".img-group-gallery").colorbox(
            {rel:"gallery-images",width:"90%",height:"auto",current:"{current}/{total}"});
        $(".img-slideshow").colorbox({rel:"gallery-slideshow",width:"auto",height:"90%",slideshow:true,current:"{current}/{total}"})}*/
    var r=$("#searchbox");
    ...
    i.isotope(
        {animationEngine:"best-available",animationOptions:{duration:200,queue:false},layoutMode:"fitRows"});
